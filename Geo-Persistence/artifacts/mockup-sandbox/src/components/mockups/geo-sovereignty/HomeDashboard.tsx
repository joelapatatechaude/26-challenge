          ...
          <div className="flex-1 flex flex-col gap-6">
            <Card className="bg-[var(--rh-charcoal-mid)] border-[var(--rh-charcoal-light)] text-white">
              ...
              <CardContent className="space-y-3">
                <Button className="w-full justify-start gap-3 bg-[var(--rh-red)] hover:bg-[var(--rh-red-dark)] text-white h-11">
                  <Plus className="w-4 h-4" />
                  Generate Presentation
                </Button>
                <Button variant="outline" className="w-full justify-start gap-3 border-[var(--rh-charcoal-light)] hover:bg-[var(--rh-charcoal-light)] hover:text-white h-11 text-[var(--rh-silver)] bg-[var(--rh-charcoal)]">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 rounded-md bg-[var(--rh-charcoal)] border border-[var(--rh-charcoal-light)]">
                    ...
                    <div>
                      ...
                      <Button variant="link" className="h-auto p-0 text-[var(--rh-blue)] text-xs mt-2">View Queue →</Button>
                    </div>
                  </div>
                </div>
              </CardContent>
...
function NewsCard({ title, source, time, type, typeColor, content }: any) {
  return (
    <div className="p-4 rounded-md bg-[var(--rh-charcoal)] border border-[var(--rh-charcoal-light)] hover:border-[var(--rh-silver)] transition-colors cursor-pointer">
      <div className="flex items-start justify-between mb-2">
        ...
        <Badge variant="outline" className={`text-[10px] uppercase bg-transparent ${typeColor}`}>{type}</Badge>
      </div>
